/* Calibration code for two  cameras
 * Camera indices are assumed to be 1, 2
 * Usage ./stereocalibrate <number of boards> <horizontal squares> <vertical squares>
 * ./stereocalibrate 25 9 6
 * Calibration data is stored in mystereocalib.yml file
 */
